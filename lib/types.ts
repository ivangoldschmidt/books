...
export type LibraryItem = {id:string;user_id:string;book_key:string;status:ShelfStatus;read_count:number;rating:number|null;book:Book;created_at:string;updated_at:string;finished_at:string|null};
